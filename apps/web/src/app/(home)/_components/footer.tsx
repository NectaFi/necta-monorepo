  ...
  return (
    <div className="w-full bg-[#101010]">
      <div className="container mx-auto max-w-[1250px] px-4 pt-12 md:pt-16 lg:pt-32">
        <footer className="border-white/10 border-t px-4 py-12">
          <div className="flex flex-col gap-8 md:flex-row md:justify-between">
            <div>
              ...
              Optimizing yields with agentic intelligence.
              </p>
            ...
            <nav className="grid grid-cols-2 gap-6 sm:grid-cols-3 md:flex md:gap-12">
              {Object.entries(FOOTER_MENU).map(([category, items]) => (
                <div key={category}>
                  <h3 className="font-sans font-semibold text-white">{category}</h3>
        ...
        <span className="mx-auto block max-w-[1200px] bg-gradient-to-b from-white/20 to-white/5 bg-clip-text text-center font-bold font-sans text-[60px] text-transparent leading-none tracking-tight md:text-[100px] lg:text-[180px]">
          Necta Finance
        </span>
      </div>
    </div>
